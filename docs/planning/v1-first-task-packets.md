...
- **A.5 — acceptable-use ack on `CapacityBid`** ⏳ (a signed field the consumer sets attesting acceptance of the provider's stated restrictions — liability allocation record).
