...
- **N136.4 — LIVE cross-NAT punch proof** ⏳ *(deploy-only):* the actual source↔sink hole-punch on real NAT'd hosts — cannot be unit-tested (no NAT on loopback), the analog of #104's H4 / #103's live smokes; #133's standing triangle proves it.
