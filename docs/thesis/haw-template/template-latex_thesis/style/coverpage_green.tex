...
\definecolor{farbe1}{cmyk}{0.83,0.09,0.79,0.08}
...
\ifdefined\ILanguageEN
  % english version of faculty only
...
\end{titlepage}
\                % this backslash is needed, otherwise LaTeX does weired things ....
