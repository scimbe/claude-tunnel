...
Ueber den evaluierten Prototyp hinaus wurde das Testbett zu einem betreibbaren
Dienst weitergefuehrt (Kapitel~\ref{ch:produktivierung}): durabler Zustand,
konventionelle Identitaet ueber OIDC, eine interne PKI mit
Wurzel-Vertrauen, reproduzierbare Auslieferung als Self-Host- und
Kubernetes-Variante, Haertung sowie eine signaturgesicherte Abrechnung. Die
zentrale Eigenschaft bleibt dabei erhalten -- der Betreiber kann die Nutzlast
weiterhin nicht lesen; aufgegeben wurde bewusst nur die Pseudonymitaet zugunsten
konventioneller Konten.
...
\begin{itemize}
  ...
  \item \textbf{Sybil-Oekonomie.} Der finanzierte Angreifer (A4) bleibt offen:
    auch die in der Produktivierung eingefuehrten konventionellen Konten
    schrecken ihn nicht ab, da er reale Kosten traegt. Kosten pro schaedlicher
    Aktion oder eine kontogebundene Reputation koennten hier ansetzen, wo der
    reine Token-Preis nicht genuegt.
