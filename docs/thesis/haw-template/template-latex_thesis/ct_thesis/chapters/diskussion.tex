...
\begin{description}
  \item[Finanzierter Sybil-Angriff (A4).] Pseudonyme, prepaid-gedeckte Konten
    verteuern Missbrauch, loesen die Sybil-Oekonomie aber nicht: wer zahlt, kann
    beliebig viele Tokens erwerben. Eine Abwehr muesste die Kosten pro
    schaedlicher Aktion ueber den Token-Preis hinaus anheben oder Reputation
    einfuehren -- beides im Spannungsfeld zur Pseudonymitaet.
