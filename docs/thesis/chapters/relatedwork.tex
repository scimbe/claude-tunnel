...
her. Bei WireGuard etwa terminiert die Verschlüsselung an den beiden Peers
...
Reverse-Tunnel-Dienste wie Cloudflare Tunnel, ngrok oder Tailscale Funnel lösen
...
Tor und allgemeiner das Onion-Routing verfolgen ein anderes Bedrohungsmodell:
...
transports} wie obfs4 oder Shadowsocks ergänzen dies um Verschleierung des
Verkehrsmusters, um Deep-Packet-Inspection und Protokollfilter zu unterlaufen.
Diese Systeme schützen also primär die \emph{Identität} und die
\emph{Beobachtbarkeit} der Kommunikation gegenüber Netzbeobachtern.
...
als primären Sybil- und Flutungs-Schutz.
...
schnellen Aufbau vieler kurzlebiger Tunnel. Das MASQUE-Framework baut auf QUIC
